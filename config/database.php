    ...
    */
    ...
    'connections' => [
        ...
        'system' => [
            ...
            'database' => env('DB_SYSTEM_DATABASE', 'flowsync_system'),
            'username' => env('DB_USERNAME', 'flowsync'),
        ...
        // Ephemeral connection whose server settings are overridden per tenant by
        // TenantDatabaseManager using the tenant's DSN (dedicated PG database).
        'tenant' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '5432'),
            'database' => env('DB_TENANT_DATABASE', 'flowsync_tenant'),
            'username' => env('DB_USERNAME', 'flowsync'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
